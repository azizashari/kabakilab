...
public class katalog53 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog53);
        ...
        collapsingToolbarLayout.setTitle("Fructose");
        ...
        */
        ...
        textView.setText("53.	Fructose/C6H12O6);*/
