...
public class katalog63 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog63);
        ...
        collapsingToolbarLayout.setTitle("di-Potassium Hydrogen Phosphate trihydrate");
        ...
        */
        ...
        textView.setText("63.	di-Potassium Hydrogen Phosphate trihydrate/HK2HO4P.3H2O));*/
