...
public class katalog29 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog29);
        ...
        collapsingToolbarLayout.setTitle("Cresol Red");
        ...
        */
        ...
        textView.setText("29.Cresol Red/C21H18O5S);*/
        ...
        textView5.setText("- Sangat berbahaya jika terjadi kontak dengan saluran pencernaan.\n" +
                "- Berbahaya jika terjadi kontak dengan mata dan saluran pernapasan.\n" +
