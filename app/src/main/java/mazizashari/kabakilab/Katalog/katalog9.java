...
public class katalog9 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog9);
        ...
        collapsingToolbarLayout.setTitle("Magnesium Sulfate");
        ...
        */
        ...
        textView.setText("9.Magnesium Sulfate/MgSO4);*/
        ...
        textView5.setText("- Berbahaya jika terjadi kontak dengan kulit, mata, saluran pencernaan dan saluran pencernaan.\n" +
                "- Sedikit berbahaya jika terjadi kontak dengan kulit, mata dan saluran pernapasan.");
