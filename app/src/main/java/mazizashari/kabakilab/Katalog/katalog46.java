...
public class katalog46 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog46);
        ...
        collapsingToolbarLayout.setTitle("Brilliant Green Bile");
        ...
        */
        ...
        textView.setText("46.	Brilliant Green Bile);*/
        ...
        textView7.setText("- Bahaya kesehatan : 0\n" +
