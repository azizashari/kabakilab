...
public class katalog38 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog38);
        ...
        collapsingToolbarLayout.setTitle("Phenolphthalein");
        ...
        */
        ...
        textView.setText("38.Phenolphthalein/C20H14O4);*/
        ...
        textView5.setText("- Berbahaya jika terjadi kontak dengan mata dan saluran pencernaan\n" +
                "- Sedikit berbahaya jika terjadi kontak dengan kulit, dan saluran pernapasan.");
        TextView textView6 = (TextView) findViewById(R.id.textView6);
        textView6.setText("* Skala bahaya");

        TextView textView7 = (TextView) findViewById(R.id.textView7);
        textView7.setText("- Bahaya kesehatan : 2\n" +
                "- Bahaya kemudahan terbakar : 3\n"+
