...
public class katalog27 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog27);
        ...
        collapsingToolbarLayout.setTitle("Calcium Chloride Dihydrate");
        ...
        */
        ...
        textView.setText("27. Calcium Chloride Dihydrate/ CaCl2.2H2O);*/
        ...
        textView5.setText("- Sangat berbahaya jika terjadi kontak dengan mata, kulit, saluran pencernaan dan saluran pernapasan\n" +
                "- Berbahaya jika terjadi kontak langsung dengan mata dan saluran pernapasan\n" +
        ...
        textView17.setText("- Pakailah pakaian pelindung yang sesuai (jas lab, masker dan sarung tangan.\n" +
                ...
                "- Jauhkan dari zat asam dan logam");
    }
