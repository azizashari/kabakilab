...
public class katalog51 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog51);
        ...
        collapsingToolbarLayout.setTitle("EMB (Eosin Methylene Blue) Agar");
        ...
        */
        ...
        textView.setText("51. EMB (Eosin Methylene Blue) Agar");*/
        ...
        textView3.setText(Html.fromHtml("<b><font color=#008000>Merek</font><br/></b>Merck dan Sigma"));
