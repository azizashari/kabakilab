...
public class katalog60 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog60);
        ...
        collapsingToolbarLayout.setTitle("NA (Nutrient Agar");
        ...
        */
        ...
        textView.setText("60.	NA (Nutrient Agar));*/
