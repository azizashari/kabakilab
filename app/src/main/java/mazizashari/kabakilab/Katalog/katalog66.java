...
public class katalog66 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog66);
        ...
        collapsingToolbarLayout.setTitle("Sodium Carbonate");
        ...
        */
        ...
        textView.setText("66.	Sodium Carbonate/Na2CO3"));*/
        ...
        textView5.setText("- Berbahaya jika terjadi kontak dengan mata, saluran pencernaan, saluran pernapasan dan kulit.");
