...
public class katalog14 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog14);
        ...
        collapsingToolbarLayout.setTitle("Potassium Sulfate");
        ...
        */
        ...
        textView.setText("14.Potassium Sulfate/K2SO4);*/
