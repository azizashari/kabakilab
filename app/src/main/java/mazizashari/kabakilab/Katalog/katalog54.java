...
public class katalog54 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog54);
        ...
        collapsingToolbarLayout.setTitle("Gelatin");
        ...
        */
        ...
        textView.setText("54.Gelatin/C76H124O29N24);*/
        ...
        textView5.setText("- Sedikit berbahaya jika terjadi kontak dengan kulit, mata, saluran pencernaan dan saluran pernapasan.");
