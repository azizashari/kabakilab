...
public class katalog52 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog52);
        ...
        collapsingToolbarLayout.setTitle("Fluorocult/E.coli 0157:H7-Agar");
        ...
        */
        ...
        textView.setText("52.	Fluorocult/E.coli 0157:H7-Agar);*/
