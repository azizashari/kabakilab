...
public class katalog68 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog68);
        ...
        collapsingToolbarLayout.setTitle("Sodium Thiosulfate");
        ...
        */
        ...
        textView.setText("68.	Sodium Thiosulfate/Na2S2O3"));*/
