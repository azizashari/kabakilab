...
public class katalog33 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog33);
        ...
        collapsingToolbarLayout.setTitle("Iodine");
        ...
        */
        ...
        textView3.setText(Html.fromHtml("<b><font color=#008000>Merek</font><br/></b>Scharlau"));
        ...
        textView5.setText("- Sangat berbahaya jika terjadi kontak dengan saluran pencernaan dan saluran pernapasan.\n" +
                "- Berbahaya jika terjadi  kontak langsung dengan mata.\n" +
                "- Sedikit berbahaya jika terjadi kontak dengan kulit, kerusakan pari-paru, tersedak atau tidak sadarkan diri.\n" +
                "- Peradangan mata ditandai dengan mata kemerahan, berair dan gatal.\n" +
                "- Peradangan kulit ditandai dengan gatal, kemerahan dan melepuh.");
       ...
       textView8.setText(Html.fromHtml("<b><font color=#008000>Pertolongan pertama pada kecelakaan</font><br/></b>* Jika terkena mata"));
        ...
        textView17.setText("- Pakailah pakaian pelindung yang sesuai (jas lab, masker dan sarung tangan.\n" +
                ...
                "- Jauhkan dari zat pengoksidasi, pereduksi dan logam.");
    }
