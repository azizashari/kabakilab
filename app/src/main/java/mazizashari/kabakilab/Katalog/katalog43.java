...
public class katalog43 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog43);
        ...
        collapsingToolbarLayout.setTitle("Ammonium Chloride");
        ...
        */
        ...
        textView.setText("43.	Ammonium Chloride/NH4Cl);*/
