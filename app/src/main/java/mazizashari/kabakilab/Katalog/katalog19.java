...
public class katalog19 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog19);
        ...
        collapsingToolbarLayout.setTitle("Tri Sodium Citrate");
        ...
        */
        ...
        textView.setText("19.Tri Sodium Citrate/C6H5Na3O7 );*/
