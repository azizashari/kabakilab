...
public class katalog64 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog64);
        ...
        collapsingToolbarLayout.setTitle("PDA (Potato Dextrose Agar");
        ...
        */
        ...
        textView.setText("64.	PDA (Potato Dextrose Agar)"));*/
