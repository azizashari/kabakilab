...
public class katalog50 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog50);
        ...
        collapsingToolbarLayout.setTitle("Crystal Violet");
        ...
        */
        ...
        textView.setText("50.	Crystal Violet/C25H30CIN3");*/
