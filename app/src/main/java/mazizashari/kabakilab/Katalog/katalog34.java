...
public class katalog34 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog34);
        ...
        collapsingToolbarLayout.setTitle("Mercury (II) Oxide");
        ...
        */
        ...
        textView.setText("34. Mercury (II) Oxide/ HgO);*/
        ...
        textView5.setText("- Sangat berbahaya sekali jika kontak dengan saluran pencernaan.\n" +
                "- Sangat berbahaya jika kontak dengan saluran pernapasan.\n" +
                "- Berbahaya jika terjadi kontak dengan kulit.\n" +
                "- Sedikit berbahaya jika terjadi kontak dengan mata.\n" +
