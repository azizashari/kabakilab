...
public class katalog57 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog57);
        ...
        collapsingToolbarLayout.setTitle("Maltose Monohydrate");
        ...
        */
        ...
        textView.setText("57.	Maltose Monohydrate/C12H22O11.H2O");*/
