...
public class katalog44 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog44);
        ...
        collapsingToolbarLayout.setTitle("Argenti Nitrat");
        ...
        */
        ...
        textView.setText("44.	Argenti Nitrat/AgNO3);*/
        ...
        textView3.setText(Html.fromHtml("<b><font color=#008000>Merek</font><br/></b>Brataco"));
