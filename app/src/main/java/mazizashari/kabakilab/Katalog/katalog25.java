...
public class katalog25 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog25);
        ...
        collapsingToolbarLayout.setTitle("Bromocresol Green");
        ...
        */
        ...
        textView.setText("25.Bromocresol Green/ C21H14Br4O5S);*/
        ...
        textView5.setText("- Berbahaya jika terjadi kontak dengan mata, kulit, saluran pencernaan dan saluran pernapasan.");
