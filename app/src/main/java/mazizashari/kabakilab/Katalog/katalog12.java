...
public class katalog12 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog12);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        CollapsingToolbarLayout collapsingToolbarLayout = (CollapsingToolbarLayout) findViewById(R.id.toolbar_layout);
        collapsingToolbarLayout.setTitle("Potassium Dichromate");
        ...
        */
        ...
        textView.setText("12.Potassium Dichromate/K2Cr2O7);*/
        ...
        textView5.setText("- Sangat berbahaya sekali jika terjadi kontak dengan kulit.\n" +
                "- Kontak dengan kulit dalam waktu yang lama dapat menyebabkan kulit seperti terbakar. Peradangan pada kulit ditandai dengan gatal, kemerahan dan melepuh.\n" +
                "- Sangat berbahaya jika terjadi kontak dengan mata dan saluran pencernaan. Peradangan pada mata ditandai dengan mata kemerahan, berair dan gatal.\n" +
                "- Berbahaya jika terjadi kontak dengan saluran pernapasan. Paparan dalam jumlah yang banyak dapat menyebabkan iritasi saluran pernapasan.\n" +
                "- Paparan dalam jumlah banyak dan durasi yang lama dapat menyebabkan kematian.");
        TextView textView6 = (TextView) findViewById(R.id.textView6);
        textView6.setText("* Skala bahaya");

        TextView textView7 = (TextView) findViewById(R.id.textView7);
        textView7.setText("- Bahaya kesehatan : 4\n" +
