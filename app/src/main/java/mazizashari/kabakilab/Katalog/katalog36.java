...
public class katalog36 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog36);
        ...
        collapsingToolbarLayout.setTitle("Methyl Red");
        ...
        */
        ...
        textView.setText("36.Methyl Red/ C15H15N3O2);*/
        ...
        textView5.setText("- Berbahaya jika terjadi kontak dengan saluran pencernaan\n" +
                "- Sedikit berbahaya jika terjadi kontak dengan mata,  kulit, dan saluran pernapasan.");
