...
public class katalog48 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog48);
        ...
        collapsingToolbarLayout.setTitle("Chromogenic Coliform Agar");
        ...
        */
        ...
        textView.setText("48.	Chromogenic Coliform Agar);*/
