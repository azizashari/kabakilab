...
public class katalog24 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog24);
        ...
        collapsingToolbarLayout.setTitle("Barium Chloride");
        ...
        */
        ...
        textView.setText("24. Barium Chloride/BaCl2);*/
        ...
        textView5.setText("- Sangat berbahaya sekali jika terjadi kontak dengan mata dan saluran pencernaan.\n" +
