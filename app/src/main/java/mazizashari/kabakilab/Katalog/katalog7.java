...
public class katalog7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog7);
        ...
        collapsingToolbarLayout.setTitle("Lead (II) Acetate Triydrate");
        ...
        */
        ...
        textView.setText("7.Lead (II) Acetate Triydrate/Pb(CH3COO)2.3H2O);*/
