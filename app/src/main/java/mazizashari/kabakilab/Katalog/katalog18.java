...
public class katalog18 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog18);
        ...
        collapsingToolbarLayout.setTitle("di-Sodium Oxalate");
        ...
        */
        ...
        textView.setText("18. di-Sodium Oxalate/(COO)2Na2);*/
