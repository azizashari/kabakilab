...
public class katalog56 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog56);
        ...
        collapsingToolbarLayout.setTitle("Lactose Monohydrate");
        ...
        */
        ...
        textView.setText("56.Lactose Monohydrate/C12H22O11.H2O);*/
        ...
        textView5.setText("- Sedikit berbahaya jika terjadi kontak dengan kulit, mata dan saluran pernapasan.");
