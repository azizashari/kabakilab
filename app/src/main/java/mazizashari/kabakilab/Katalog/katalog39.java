...
public class katalog39 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog39);
        ...
        collapsingToolbarLayout.setTitle("Potassium Hydrogen Phthalat");
        ...
        */
        ...
        textView.setText("39. Potassium Hydrogen Phthalat/C8H6O4K);*/
        ...
        textView5.setText("- Sedikit berbahaya jika terjadi kontak dengan kulit, saluran pencernaan dan saluran pernafasan.");
