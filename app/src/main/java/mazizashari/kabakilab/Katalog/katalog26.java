...
public class katalog26 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog26);
        ...
        collapsingToolbarLayout.setTitle("Bromothymol Blue");
        ...
        */
        ...
        textView.setText("26.Bromothymol Blue/ C27H28Br2O5S);*/
