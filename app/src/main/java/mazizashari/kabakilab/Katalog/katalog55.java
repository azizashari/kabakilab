...
public class katalog55 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog55);
        ...
        collapsingToolbarLayout.setTitle("Lactose Broth");
        ...
        */
        ...
        textView.setText("55. Lactose Broth);*/
