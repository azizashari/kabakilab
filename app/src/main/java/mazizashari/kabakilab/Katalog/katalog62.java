...
public class katalog62 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog62);
        ...
        collapsingToolbarLayout.setTitle("PCA (Plate Count Agar)");
        ...
        */
        ...
        textView.setText("62.	PCA (Plate Count Agar));*/
