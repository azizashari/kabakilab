...
public class katalog16 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog16);
        ...
        collapsingToolbarLayout.setTitle("Sodium Acetate Trihydrate");
        ...
        */
        ...
        textView.setText("16.Sodium Acetate Trihydrate/CH3COONa.3H2O);*/
        ...
        textView5.setText("- Sedikit berbahaya jika terjadi kontak dengan kulit, mata, saluran pernapasan dan saluran pencernaan");
