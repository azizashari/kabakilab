...
public class katalog65 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog65);
        ...
        collapsingToolbarLayout.setTitle("Salmonella-Shigella Agar");
        ...
        */
        ...
        textView.setText("65.Salmonella-Shigella Agar"));*/
