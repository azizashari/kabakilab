...
public class katalog10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_katalog10);
        ...
        */
        ...
        textView.setText("10.Mercury (II) Iodide/HgI2);*/
        ...
        textView5.setText("- Sangat berbahaya jika terjadi kontak dengan kulit, mata, saluran pencernaan dan saluran pencernaan.\n" +
                "- Paparan dalam jumlah banyak dapat menyebabkan kematian.\n" +
                "- Peradangan pada mata ditandai dengan mata kemerahan dan melepuh.");
