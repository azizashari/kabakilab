...
public class katalog67 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog67);
        ...
        collapsingToolbarLayout.setTitle("Sodium Chloride");
        ...
        */
        ...
        textView.setText("67.	Sodium Chloride/NaCl"));*/
        ...
        textView5.setText("- Sedikit berbahaya apabila terjadi kontak dengan kulit, mata dan saluran pernapasan.");
