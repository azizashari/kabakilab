...
import mazizashari.kabakilab.ListReagen;
 ...
 public class katalog15 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog15);
        ...
        collapsingToolbarLayout.setTitle(" Sodium Acetate Anhydrous");
        ...
        */
        ...
        textView.setText("15. Sodium Acetate Anhydrous/CH3COONa);*/
        ...
        textView5.setText("- Berbahaya jika terjadi kontak dengan saluran pencernaan dan saluran pernapasan.\n" +
                "- Sedikit berbahaya jika terjadi kontak dengan kulit dan mata.");
