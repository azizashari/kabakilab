...
public class katalog61 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_katalog61);
        ...
        collapsingToolbarLayout.setTitle("Nutrient Broth");
        ...
        */
        ...
        textView.setText("61.	Nutrient Broth));*/
